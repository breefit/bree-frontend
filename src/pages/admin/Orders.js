...
/* ── order-detail modal ──────────────────────────────────────────────────── */
// Exported (in addition to being used inline by Orders below) so it can be
// rendered in isolation by a real behavioral test — see
// Orders.approveRefund.test.js (ISSUE-005).
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap justify-end gap-2">
                      ...
                      {/* FIX (ISSUE-011): 'processing' is the brief,
                        request-scoped claim completeRefund holds while it
